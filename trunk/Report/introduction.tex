...
\xymatrix{
*+<0.5cm>[F-,]{Segmentation} \ar[r] \ar[d] & *+<0.5cm>[F-,]{Detection} \ar[r] \ar[d] &
*+<0.5cm>[F-,]{Representation}  \ar[r] & *+<0.5cm>[F-,]{Tracking} 
\\
*+<0.5cm>[F-,]{Grey-World} \ar[d] & *+<0.5cm>[F-,]{Face Detection}\ar[d]\\
*+<0.5cm>[F-,]{Eigenbackground}  & *+<0.5cm>[F-,]{Face recognition}
}
